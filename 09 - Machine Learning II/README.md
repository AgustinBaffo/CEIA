...
- [real_time_prediction_cloud.py](./1_gcp_real_time_prediction/real_time_prediction_cloud.py): Es un script que se ejecuta en la vm
- [real_time_prediction.py](./1_gcp_real_time_prediction/real_time_prediction.py):
- [preprocess.pickle](./1_gcp_real_time_prediction/preprocess.pickle):
